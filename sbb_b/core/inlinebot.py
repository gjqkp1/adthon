...
CATLOGO = "https://telegra.ph/file/420f3bbc6345002df8baf.jpg"
...
def main_menu():
    text = f"**▾∮ مرحبا عزيزي {mention}**\n**▾اليكَ قائمة بازرار مضمنة لاوامر ↫**⍣ⵧⵧⵧⵧⵧ𝐀𝐝𝐭𝐡𝐨𝐧 ⵧⵧⵧⵧⵧ⍣**\n[ 𝐀𝐝𝐭𝐡𝐨𝐧 𝙐𝙎𝙀𝙍𝘽𝙊𝙏 🧸♥](https://t.me/adthone)\n\n"
    buttons = [
...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**sbb_b"):
            buttons = [
                (
                    ...
                    Button.url("DEV", "https://t.me/adthone"),
                )
            ]
            ...
            result = builder.article(
                title="sbb_b Help™",
                description="**▾∮ قائمة التعليمات الخاصة ب ادثون **",
                text=_result[0],
                buttons=_result[1],
                link_preview=False,
            )
            ...
            if found_:
                ...
                photo = types.InputWebDocument(
                    url=photo, size=0, mime_type="image/jpg", attributes=[]
                )
            ...
            if CAT_IMG and CAT_IMG.endswith((".jpg", ".jpg", ".png")):
                result = builder.photo(
                    CAT_IMG,
                    # title="Alive cat",
                    text=query,
        ...
        buttons = [
            (
                Button.url("قناة السورس", "t.me/adthone"),
                Button.url(
                    "المطور",
                    "t.me/PPF22",
                ),
        ...
        markup = event.client.build_reply_markup(buttons)
        photo = types.InputWebDocument(
            url=CATLOGO, size=0, mime_type="image/jpg", attributes=[]
        )
        text, msg_entities = await event.client._parse_message_text(
            "لجعل ادثون من نصيبك!", "md"
        )
        result = types.InputBotInlineResult(
            id=str(uuid4()),
            type="photo",
            title="[𝐀𝐝𝐭𝐡𝐨𝐧 𝙐𝙎𝙀𝙍𝘽𝙊𝙏 🧸♥](https://t.me/adthone)",
