...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"""ُهاެ ُهݪا {mention} \n .مَاެݪڪٰٖہ اެݪحُسَاެبَ اެݪاެنِ غِيِࢪ مَوَجَوَدِ ​​​​​​​​​​​​​​​​​​​​​​​​​​🤍 \n اެڪٰٖہتَبَ ࢪسَاެݪتَڪٰٖہ وَاެنِتَظَࢪ اެݪࢪدِ ​​​​​​​​​​​​​​​​​​​​​​​​​​🤍.

؏َـنِدِڪٰٖہ {warns}/{totalwarns} تَحُذِيِࢪاެتَ. """
    else:
        USER_BOT_NO_WARN = f"""ُهاެ ُهݪا {mention} \n .مَاެݪڪٰٖہ اެݪحُسَاެبَ اެݪاެنِ غِيِࢪ مَوَجَوَدِ ​​​​​​​​​​​​​​​​​​​​​​​​​​🤍 \n اެڪٰٖہتَبَ ࢪسَاެݪتَڪٰٖہ وَاެنِتَظَࢪ اެݪࢪدِ ​​​​​​​​​​​​​​​​​​​​​​​​​​🤍.
...
async def on_plug_in_callback_query_handler(event):
    ...
    try:
        ...
        PM_WARNS = {}  # ترجمه وكتابة فريق ادثون
    if str(event.query.user_id) in PM_WARNS:
        del PM_WARNS[str(event.query.user_id)]
        sql.del_collection("pmwarns")
        sql.add_collection("pmwarns", PM_WARNS, {})
...
@sbb_b.ar_cmd(pattern="الحماية (تشغيل|تعطيل)$")  # ترجمه وكتابة فريق ادثون
...
async def pmpermit_on(event):
    input_str = event.pattern_match.group(1)
    if input_str == "تعطيل":
        if gvarstatus("pmmenu") is None:  # ترجمه وكتابة فريق ادثون
...
async def approve_p_m(event):
    ...
    await edit_or_reply(
        event,
        APPROVED_PMs,
        file_name="قائمة الحماية ادثون.txt",
