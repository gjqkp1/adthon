...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "**父[ 𝚃‌𝙴𝙿𝚃𝙷𝙾𝙽‌ 𝙸𝚂 𝚆𝙾𝚁𝙺𝙸𝙽𝙶 ✓ ](t.me/adthon)父**"
...
def jmthonalive_text():
    ...
    jmthon_caption += f"**{EMOJI} اصدار ادثون :** `{jmthonversion}`\n"
...
ROZ_PIC = "https://telegra.ph/file/420f3bbc6345002df8baf.jpg"
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("السورس") and event.query.user_id == sbb_b.uid:
            buttons = [
                [
                    Button.url("قنـاة السـورس ⚙️", "https://t.me/adthone"),
