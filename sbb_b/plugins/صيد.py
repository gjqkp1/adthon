...
async def _(event):
    await event.edit(
        """
أوامر الصيد الخاصة بسورس ادثون : 
        ...
        try:
            ch = await sbb_b(
                functions.channels.CreateChannelRequest(
                    title="adthon HUNTER - صيد ادثون",
                    about="This channel to hunt username by - @adthon ",
                )
            )
